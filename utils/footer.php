            ...
            <section class="col-lg-4 align-middle m-auto">
                <div class = "footerContent">
                    <p class = "footerContent1" style="font-family:monospace">
                        ...
                        <strong>M</strong><span class = "small footerSubtext">odern</span><br>
                        <strong>S</strong><span class = "small footerSubtext">olutions</span>
                    </p>
                    <p class = "footerSubtext2" style="font-family:monospace">
                    IPR 20KSKB7022
                    </p>
                </div>
            </section>
